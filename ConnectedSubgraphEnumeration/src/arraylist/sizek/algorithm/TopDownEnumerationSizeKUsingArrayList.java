...
public class TopDownEnumerationSizeKUsingArrayList extends SubgraphEnumerationAlgorithmUsingArrayList {
	...
	public void enumerate() {
		...
		while (i.hasNext()) {
			...
			topDownEnumeration(subgraphWithEdges, subgraph, nonArticulationPoints, A, B, mustInculdedVertices,mustIncludedVerticesBooleanArray);
		}
		if (pw != null)
			pw.close();
	}

	public void topDownEnumeration(ArrayList<Integer>[] subgraphWithEdges, BitSet subgraph, BitSet nonArticulationPoints,
